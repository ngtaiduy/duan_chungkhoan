            ...
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        ...
                        <span class="text-sm text-gray-700 dark:text-gray-500">Xin chào, <a href="{{ route('user.detail', ['id' => Auth::user()->id]) }}" class="text-sm text-gray-700 dark:text-gray-500 underline">{{Auth::user()->name}}</a></span>
